...
DEFAULT_CONFIG = SRC_DIR / "intelligence" / "source_policy.toml"
DEFAULT_EARLY_CONFIG = DEFAULT_CONFIG
DISCOVERY_SCRIPT = DISCOVERY_DIR / "rsshub_discovery.py"
EARLY_SIGNAL_SCRIPT = DISCOVERY_DIR / "early_signal_discovery.py"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--skip-healthcheck", action="store_true", help="Deprecated compatibility flag; health checks are no longer run here.")
    parser.add_argument("--healthcheck-out", help="Deprecated compatibility path; health checks are no longer run here.")
    parser.add_argument(
        "--check-x-browser",
        action="store_true",
        help="Deprecated compatibility flag; browser health checks are no longer run here.",
    )
    parser.add_argument(
        "--strict",
        action="store_true",
